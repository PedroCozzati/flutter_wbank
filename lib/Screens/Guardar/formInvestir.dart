...
class FormInvestir extends StatefulWidget {
  @override
  FormInvestirState createState() => FormInvestirState();
}

class FormInvestirState extends State<FormInvestir> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Quanto deseja investir"),
    ),
    body: Padding(
          ...
          Padding(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Investir',style: TextStyle(fontSize: 17),)
          ),
            ),
          ),
        ],
  ...
  void _criarCadastro(BuildContext context){
    ...
    if (_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Dinheiro Investido')));
